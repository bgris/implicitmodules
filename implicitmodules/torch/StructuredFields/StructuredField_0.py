...
from implicitmodules.torch.Kernels.kernels import gauss_kernel, rel_differences, keops_gauss_kernel
...
class StructuredField_0(SupportStructuredField):
    ...
    def __call__(self, points, k=0):
        ...
        # res2 = torch.tensordot(torch.transpose(torch.tensordot(torch.eye(2), ker_vec, dims=0), 0, 2), self.moments,dims=([2, 3], [1, 0]))
        return res
