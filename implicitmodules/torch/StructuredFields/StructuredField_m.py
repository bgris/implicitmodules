...
class StructuredField_m(SupportStructuredField):
    ...
    def __call__(self, points, k=0):
        ...
        # print(self.support.shape, self.support.device)
        # print(self.moments.shape, self.moments.device)
        ...
        return torch.tensordot(torch.transpose(torch.tensordot(torch.eye(2, device=points.device), ker_vec, dims=0), 0, 2), P, dims=([2, 3, 4], [1, 0, 2]))
