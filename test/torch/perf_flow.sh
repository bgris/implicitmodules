...
numactl -N 0 python3 perf_simple_shooting.py cpu euler 2500 700 700 -it 10 -loops 5
numactl -N 0 python3 perf_simple_shooting.py cpu euler 5000 1500 1500 -it 10 -loops 2
