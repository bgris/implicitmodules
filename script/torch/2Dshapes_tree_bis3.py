...
lam = 50.
modelgrowth = dm.Models.RegistrationModel([source_deformable], [global_translation, translations, growth], [attachment], fit_gd=[False], lam=lam)
...
pickle.dump(modelgrowth.init_manifold, open( "../../Results/Tree/Mixte_growthtot_init_manifold" + "_lam_" + str(lam) + "_coefftrans_" + str(coefftrans) + str(ind_subj_source) + '_' + str(ind_subj_target) + ".p", "wb" ) )
