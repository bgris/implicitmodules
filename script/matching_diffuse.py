...
name_exp = 'diffuse_semi_parametric'
...
coeffs =[0.01, 0.1, 0.01]
coeffs_str = '0_01__0_1__0_01'

# Source
path_data = '../data/'
with open(path_data + 'diffuse.pkl', 'rb') as f:
    _, lx = pickle.load(f)
